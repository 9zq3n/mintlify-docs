...
<Info>
  The `#jail-log` channel logs all moderation actions done through adore (e.g.
...
It's important to set the staff roles in your server to ensure that adore can identify who has dangerous permissions. This is necessary for the `stripstaff` punishment to work.
