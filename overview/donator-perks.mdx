...
Donator perks can be purchased via **server subscriptions** in our [Support Server](https://http://adore.rest/invite) which can be found at the top of the channel list labeled as **Server Shop**.
...
<AccordionGroup>
    ...
    <Accordion title="Video to GIF conversion">
      ...
      <CodeGroup>
        ...
        ```
        ```javascript Example
        ,makegif https://adore.bot/backflip.mp4 100 30 2
        ```
      </CodeGroup>
    </Accordion>
    <Accordion title="Clever Chatbot">
      ...
      <Info>
        `adore clever` is the unique prefix for this command.
      </Info>
      <CodeGroup>
        ```javascript Syntax
        adore clever (question)
        ```
        ```javascript Example
        adore clever I know what you are...
        ```
      </CodeGroup>
    </Accordion>
