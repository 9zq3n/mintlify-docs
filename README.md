...
This repository contains adore's documentation that can be found [here](https://docs.adore.bot/).
...
You can find the rest of us in adore's official [Discord Server](https://discord.gg/adore).
# docs
